...
console.log(`${BLUE}🧪 EBI Tools Structured Content Regression Tests${RESET}`);

const toolExpectations = [
  {
    path: 'src/tools/submit-job.ts',
    required: ['createCodeModeResponse', 'createCodeModeError'],
  },
  {
    path: 'src/tools/job-status.ts',
    required: ['createCodeModeResponse', 'createCodeModeError'],
  },
  {
    path: 'src/tools/job-result.ts',
    required: ['createCodeModeResponse', 'createCodeModeError'],
  },
  {
    path: 'src/tools/list-tools.ts',
    required: ['createCodeModeResponse'],
  },
];
...
assertContains('src/index.ts', indexContent, 'EbiToolsDataDO', 'index.ts exports EbiToolsDataDO');
...
console.log(`\n${GREEN}✅ EBI Tools structured content regression tests passed.${RESET}`);
